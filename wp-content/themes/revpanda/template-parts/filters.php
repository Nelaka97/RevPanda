...
<div class="mb-3 sm:mb-6">
    ...
    <!--large screens-->
    <div class="hidden sm:flex justify-center font-poppins pink-text text-base font-medium gap-3">
        <button class="flex items-center border main-border px-8 py-[14px] h-[52px] rounded-sm transition">
        ...
        <button
            class="flex items-center bg-main-pink text-white border main-border px-8 py-[14px] h-[52px] rounded-sm transition">
    ...
    <!--mobile-->
    <div class="block sm:hidden max-w-[358px] mx-auto border main-border rounded-sm overflow-hidden mb-4">
        <!--toggle header-->
        <button id="sortToggle"
            class="w-full h-[48px] relative bg-main pink-text py-3 px-4 font-semibold focus:outline-none flex items-center">

            <span class="mx-auto text-base">Sort by</span>

            <!--arrow icon-->
            <svg id="toggleArrow" xmlns="http://www.w3.org/2000/svg"
                class="h-6 w-6 font-extrabold pink-text absolute right-4 top-1/2 transform -translate-y-1/2 transition-transform duration-300"
        ...
        <!--list items-->
        <ul id="sortContent"
            class="items-center justify-center px-4 max-h-0 overflow-hidden divide-y divide-[#EDD0E8] text-center pink-text font-medium text-base">
            <li class="py-3 flex justify-center items-center"><img
                    src="<?php echo get_template_directory_uri(); ?>/src/images/listings/top-rated.png" alt="top-rated"
                    class="h-5 w-5 mr-3"> Top Rated</li>
            <li class="py-3 flex justify-center items-center"><img
                    src="<?php echo get_template_directory_uri(); ?>/src/images/listings/recently-added.png"
                    alt="recently-added" class="h-5 w-5 mr-3"> Recently Added</li>
            <li class="py-3 flex justify-center items-center"><img
                    src="<?php echo get_template_directory_uri(); ?>/src/images/listings/free-spins.png"
                    alt="free-spins" class="h-5 w-5 mr-3"> Best Free Spins</li>
            <li class="py-3 flex justify-center items-center"><img
                    src="<?php echo get_template_directory_uri(); ?>/src/images/listings/best-bonus.png"
                    alt="best-bonus" class="h-5 w-5 mr-3"> Best Bonus</li>
        </ul>
    </div>
