...
<div class="mb-6">
    ...
    <!--mobile-->
    <div class="block md:hidden w-[80%] mx-auto border border-[#990085] rounded-sm overflow-hidden mb-8">
        <!--toggle header-->
        <button id="sortToggle"
            class="w-full flex items-center gap-2 relative bg-[#FEF7F9] text-[#990085] py-3 px-4 font-semibold focus:outline-none">

            <span class="mx-auto text-base">Sort by</span>

            <!--arrow icon-->
            <svg id="toggleArrow" xmlns="http://www.w3.org/2000/svg"
                class="h-5 w-5 text-[#990085] transform rotate-180 transition-transform duration-300"
        ...
        <ul id="sortContent"
            ...
            <li class="py-3 flex justify-center"><img src="<?php echo get_template_directory_uri(); ?>/src/images/listings/top-rated.png" alt="top-rated"
                class="h-5 w-5 mr-2"> Top Rated</li>
            <li class="py-3 flex justify-center"><img src="<?php echo get_template_directory_uri(); ?>/src/images/listings/recently-added.png"
                alt="recently-added" class="h-5 w-5 mr-2"> Recently Added</li>
            <li class="py-3 flex justify-center"><img src="<?php echo get_template_directory_uri(); ?>/src/images/listings/free-spins.png"
                alt="free-spins" class="h-5 w-5 mr-2"> Best Free Spins</li>
            <li class="py-3 flex justify-center"><img src="<?php echo get_template_directory_uri(); ?>/src/images/listings/best-bonus.png" alt="best-bonus"
                class="h-5 w-5 mr-2"> Best Bonus</li>
        </ul>
    </div>
